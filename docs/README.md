...
Welcome to the Chatbot Web documentation! Use this index to find what you need.
...
View detailed sequence and component diagrams in [diagrams/](../diagrams/)
...
- [Complete Folder Structure Guide](../FOLDER_STRUCTURE.md) - Detailed breakdown of all directories
...
3. **Contributing Documentation**:
   - Add new docs to appropriate subfolder (guides/, features/, api/, architecture/)
...
- Check the relevant guide or architecture document
